window.addEventListener("DOMContentLoaded", function () {
    ...
    if (localStorage.getItem("theme") == "night") {
        if (localStorage.getItem("custombg") == '') {
            document.getElementById("bg").setAttribute("src", "/assets/imgs/bg/night.jpg");
        }
        ...
        if (localStorage.getItem("custombg") == '') {
            document.getElementById("bg").setAttribute("src", "/assets/imgs/bg/quartz.avif");
        }
        ...
        if (localStorage.getItem("custombg") == '') {
            document.getElementById("bg").setAttribute("src", "/assets/imgs/bg/flourishing.jpg");
        }
